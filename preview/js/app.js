...
const App = {
    ...
    getMemberCenterHTML() {
        ...
        if (currentTab === 'free') {
            ...
            cardContent = `<div style="background: linear-gradient(135deg, #2C5F2D, #1E3F1F); color: white; padding: 24px; border-radius: 16px; position: relative; overflow: hidden; height: 180px;"><div style="position: relative; z-index: 2; height: 100%; display: flex; flex-direction: column;"><div style="display: flex; justify-content: space-between; align-items: flex-start;"><div><div style="font-size: 24px; font-weight: 800; margin-bottom: 8px; display: flex; align-items: center;">${cityIcon}${cityCopy.title}</div><div style="font-size: 14px; opacity: 0.9; margin-bottom: 12px;">${cityCopy.subtitle}</div></div><div style="text-align: right;"><div style="font-size: 20px; font-weight: 700;">${this.getPlanDisplayPrice('city', cityPrice)}</div><div style="font-size: 12px; opacity: 0.8;">/年</div></div></div><div style="flex: 1; display: flex; align-items: center; justify-content: space-between;"><div style="font-size: 13px; display: flex; flex-direction: column; gap: 4px;">${renderBenefitsHtml(cityCopy.benefits)}</div>${renderTrialBtn('city', '#2C5F2D', 'white')}</div></div></div>`;
        } else if (currentTab === 'province') {
            cardContent = `<div style="background: linear-gradient(135deg, #FFD700, #FDB931); color: #5D4037; padding: 24px; border-radius: 16px; position: relative; overflow: hidden; height: 180px;"><div style="position: relative; z-index: 2; height: 100%; display: flex; flex-direction: column;"><div style="display: flex; justify-content: space-between; align-items: flex-start;"><div><div style="font-size: 24px; font-weight: 800; margin-bottom: 8px; display: flex; align-items: center;">${provIcon}${provinceCopy.title}</div><div style="font-size: 14px; opacity: 0.9; margin-bottom: 12px;">${provinceCopy.subtitle}</div></div><div style="text-align: right;"><div style="font-size: 20px; font-weight: 700;">${this.getPlanDisplayPrice('province', provincePrice)}</div><div style="font-size: 12px; opacity: 0.8;">/年</div></div></div><div style="flex: 1; display: flex; align-items: center; justify-content: space-between;"><div style="font-size: 13px; display: flex; flex-direction: column; gap: 4px;">${renderBenefitsHtml(provinceCopy.benefits)}</div>${renderTrialBtn('province', '#5D4037', 'white')}</div></div></div>`;
        } else if (currentTab === 'country') {
            cardContent = `<div style="background: linear-gradient(135deg, #1C1C1E, #2C2C2E); color: #FFD700; padding: 24px; border-radius: 16px; position: relative; overflow: hidden; height: 180px; border: 1px solid #333;"><div style="position: relative; z-index: 2; height: 100%; display: flex; flex-direction: column;"><div style="display: flex; justify-content: space-between; align-items: flex-start;"><div><div style="font-size: 24px; font-weight: 800; margin-bottom: 8px; display: flex; align-items: center;">${countryIcon}${countryCopy.title}</div><div style="font-size: 14px; opacity: 0.9; margin-bottom: 12px;">${countryCopy.subtitle}</div></div><div style="text-align: right;"><div style="font-size: 20px; font-weight: 700;">${this.getPlanDisplayPrice('country', countryPrice)}</div><div style="font-size: 12px; opacity: 0.8;">/年</div></div></div><div style="flex: 1; display: flex; align-items: center; justify-content: space-between;"><div style="font-size: 13px; display: flex; flex-direction: column; gap: 4px;">${renderBenefitsHtml(countryCopy.benefits)}</div>${renderTrialBtn('country', '#1C1C1E', 'linear-gradient(90deg, #FFD700, #FDB931)')}</div></div></div>`;
        }
